...
const twitterid2href = function(s) {
  // TODO: change this to something that extracts the original article url from the claim review .. or the claim review url?
  s=s.split(":");
    ...
    if(type=="Claim" || type=="Link" || type=="Blank"){ //TODO: Decide whether to include imported reports ("Blank")
      ...
      var req = http.request(options, (res) => {
        ...
        res.on('end', () => {
          ...
          let text = `The closest related ClaimReviews in Google Factcheck Explorer are\n`;
